package {
	...
	public class GameState extends AxState {
		...
		private var BlackScreen:AxSprite;
		private var GameStateFade:Number = 3;
		...
		override public function create():void {
			...
			TimeText = new AxText(10, 40, null, "Gems: 0");
			...
			BlackScreen = new AxSprite(0, 0, Resource.SOLIDBLACK, tilemap.width, tilemap.height);
			BlackScreen.scroll.x = BlackScreen.scroll.y = 0;
			BlackScreen.scale.x = BlackScreen.scale.y = 1;
			add(BlackScreen);
		}
		
		override public function update():void {
			
			BlackScreen.alpha = 1 - ElapsedTime/GameStateFade;
